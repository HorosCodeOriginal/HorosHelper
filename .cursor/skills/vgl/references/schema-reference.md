# VGL-Output-Schema-Referenz

Vollständiges JSON-Schema für VGL-Prompt-Ausgabe. Nutze dies bei Validierung oder Generierung von VGL-JSON.

> **Haupt-Skill**: Siehe **[VGL SKILL.md](../SKILL.md)** für Nutzungsanleitung und Beispiele.
> **API-Integration**: Siehe **[bria-ai](../../bria-ai/SKILL.md)** zur Ausführung von VGL-Prompts.

## Vollständiges Schema (JSON-Schema-Format)
