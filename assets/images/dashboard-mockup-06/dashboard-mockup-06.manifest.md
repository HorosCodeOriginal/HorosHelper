# Bild-Manifest — HorosHelper — Wissens-Navigator
...
|------|------|
| **Canonical** | `full.png` |
| **Asset-Ordner** | `assets/images/dashboard-mockup-06/` |
| **Asset-Slug** | `dashboard-mockup-06` |
| **Absoluter Pfad** | `C:\HorosHelper\assets\images\dashboard-mockup-06\full.png` |
...
```text
CRITICAL: NOT a web browser. App name ONLY HorosHelper. Native Windows 11 desktop window, Avalonia style, Windows-Wissens- & Einstellungs-Navigator view.
Native Windows desktop HorosHelper Wissens-Navigator with search, categories, article list, detail panel and Direkt oeffnen CTA. Sidebar Wissen active.
```
...
1536 × 1024 px · 1482.2 KB · PNG · no alpha
...
| 4 | `#0f181f` | rgb(15,24,31) | 18% | Studio-Hintergrund |
...
```tsx
<img src="/assets/images/dashboard-mockup-06/full.png" alt="HorosHelper Desktop-App: Windows-Wissens-Navigator mit Suche, Kategorien, Artikelliste und Direkt-oeffnen-Button" width={1536} height={1024} />
```

```xml
<Image Source="avares://HorosHelper/Assets/Images/dashboard-mockup-06/full.png" Stretch="Uniform" />
```

## Verwendungszweck

HorosHelper Windows-Wissens- & Einstellungs-Navigator — natives Windows-Desktop-Marketing-Still (HorosCode)
