# Bild-Manifest — HorosHelper — Netzwerk-Assistent
...
|------|------|
| **Canonical** | `full.png` |
| **Asset-Ordner** | `assets/images/dashboard-mockup-09/` |
| **Asset-Slug** | `dashboard-mockup-09` |
| **Absoluter Pfad** | `C:\HorosHelper\assets\images\dashboard-mockup-09\full.png` |
...
```text
CRITICAL: NOT a web browser. App name ONLY HorosHelper. Native Windows 11 desktop window, Avalonia style, Netzwerk-Assistent view.
Native Windows desktop HorosHelper Network assistant with adapter cards, ping tracert DNS buttons, WLAN list, live latency graph. Sidebar Netzwerk active.
```
...
1536 × 1024 px · 1380.1 KB · PNG · no alpha
...
| 2 | `#1e293b` | rgb(30,41,59) | 24% | Adapter-Karten |
| 3 | `#f59e0b` | rgb(245,158,11) | 11% | Amber-Akzent |
| 4 | `#0c1824` | rgb(12,24,36) | 18% | Studio-Hintergrund |
| 5 | `#22c55e` | rgb(34,197,94) | 7% | Verbunden-Status |
...
```tsx
<img src="/assets/images/dashboard-mockup-09/full.png" alt="HorosHelper Desktop-App: Netzwerk-Assistent mit Adapter-Karten, Diagnose-Buttons und Latenz-Graph" width={1536} height={1024} />
```

```xml
<Image Source="avares://HorosHelper/Assets/Images/dashboard-mockup-09/full.png" Stretch="Uniform" />
```

## Verwendungszweck

HorosHelper Netzwerk-Assistent — natives Windows-Desktop-Marketing-Still (HorosCode)
