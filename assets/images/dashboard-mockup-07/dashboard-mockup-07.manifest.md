# Bild-Manifest — HorosHelper — Einstellungen
...
|------|------|
| **Canonical** | `full.png` |
| **Asset-Ordner** | `assets/images/dashboard-mockup-07/` |
| **Asset-Slug** | `dashboard-mockup-07` |
| **Absoluter Pfad** | `C:\HorosHelper\assets\images\dashboard-mockup-07\full.png` |
...
```text
CRITICAL: NOT a web browser. App name ONLY HorosHelper. Native Windows 11 desktop window, Avalonia style, Einstellungen view.
Native Windows desktop HorosHelper Einstellungen with category nav, toggles, theme dropdown Dark, Sprache Deutsch, scan interval slider. Sidebar Einstellungen active.
```
...
1536 × 1024 px · 1409.5 KB · PNG · no alpha
...
| 2 | `#1e293b` | rgb(30,41,59) | 24% | Formular-Karten |
| 3 | `#f59e0b` | rgb(245,158,11) | 11% | Amber-Akzent |
| 4 | `#0b131d` | rgb(11,19,29) | 18% | Studio-Hintergrund |
| 5 | `#22c55e` | rgb(34,197,94) | 5% | Toggle ON |
...
```tsx
<img src="/assets/images/dashboard-mockup-07/full.png" alt="HorosHelper Desktop-App: Einstellungen mit Kategorien, Toggles, Theme-Dropdown und Scan-Intervall-Slider" width={1536} height={1024} />
```

```xml
<Image Source="avares://HorosHelper/Assets/Images/dashboard-mockup-07/full.png" Stretch="Uniform" />
```

## Verwendungszweck

HorosHelper Einstellungen — natives Windows-Desktop-Marketing-Still (HorosCode)
