# Bild-Manifest — HorosHelper — Problem-Fixer
...
|------|------|
| **Canonical** | `full.png` |
| **Asset-Ordner** | `assets/images/dashboard-mockup-02/` |
| **Asset-Slug** | `dashboard-mockup-02` |
| **Absoluter Pfad** | `C:\HorosHelper\assets\images\dashboard-mockup-02\full.png` |
...
```text
Native Windows desktop app HorosHelper Problem-Fixer view with scan progress ring 67%, problem cards Gut/Achtung/Kritisch, Reparatur-Protokoll panel.
```
...
1536 × 1024 px · 1749.3 KB · PNG · no alpha
...
| 2 | `#1e293b` | rgb(30,41,59) | 24% | Surface-Karten |
| 3 | `#f59e0b` | rgb(245,158,11) | 14% | Amber-Akzent |
| 4 | `#0c1925` | rgb(12,25,37) | 16% | Studio-Hintergrund |
| 5 | `#ef4444` | rgb(239,68,68) | 4% | Kritisch-Badge |
...
```tsx
<img src="/assets/images/dashboard-mockup-02/full.png" alt="HorosHelper Desktop-App: Problem-Fixer mit Scan-Fortschritt, Status-Karten und Reparatur-Protokoll" width={1536} height={1024} />
```

```xml
<Image Source="avares://HorosHelper/Assets/Images/dashboard-mockup-02/full.png" Stretch="Uniform" />
```

## Verwendungszweck

HorosHelper Problem-Fixer — natives Windows-Desktop-Marketing-Still (HorosCode)
